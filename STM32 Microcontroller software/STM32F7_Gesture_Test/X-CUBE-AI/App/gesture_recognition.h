...
#ifndef AI_GESTURE_RECOGNITION_H
#define AI_GESTURE_RECOGNITION_H
#pragma once
...
/******************************************************************************/
#define AI_GESTURE_RECOGNITION_MODEL_NAME          "gesture_recognition"
#define AI_GESTURE_RECOGNITION_ORIGIN_MODEL_NAME   "model_20230226_130128"

/******************************************************************************/
#define AI_GESTURE_RECOGNITION_ACTIVATIONS_ALIGNMENT   (4)
#define AI_GESTURE_RECOGNITION_INPUTS_IN_ACTIVATIONS   (4)
#define AI_GESTURE_RECOGNITION_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_GESTURE_RECOGNITION_IN_NUM        (1)

AI_DEPRECATED
#define AI_GESTURE_RECOGNITION_IN \
  ai_gesture_recognition_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_GESTURE_RECOGNITION_IN_SIZE { \
  AI_GESTURE_RECOGNITION_IN_1_SIZE, \
}
#define AI_GESTURE_RECOGNITION_IN_SIZE_BYTES { \
  AI_GESTURE_RECOGNITION_IN_1_SIZE_BYTES, \
}
#define AI_GESTURE_RECOGNITION_IN_1_CHANNEL     (1506)
#define AI_GESTURE_RECOGNITION_IN_1_SIZE        (1506)
#define AI_GESTURE_RECOGNITION_IN_1_SIZE_BYTES  (6024)

/******************************************************************************/
#define AI_GESTURE_RECOGNITION_OUT_NUM       (1)

AI_DEPRECATED
#define AI_GESTURE_RECOGNITION_OUT \
  ai_gesture_recognition_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_GESTURE_RECOGNITION_OUT_SIZE { \
  AI_GESTURE_RECOGNITION_OUT_1_SIZE, \
}
#define AI_GESTURE_RECOGNITION_OUT_SIZE_BYTES { \
  AI_GESTURE_RECOGNITION_OUT_1_SIZE_BYTES, \
}
#define AI_GESTURE_RECOGNITION_OUT_1_CHANNEL     (10)
#define AI_GESTURE_RECOGNITION_OUT_1_SIZE        (10)
#define AI_GESTURE_RECOGNITION_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_GESTURE_RECOGNITION_N_NODES (6)
 ...
 * @ref ai_gesture_recognition_create. Both the activations memory buffer 
 ...
 * using @ref ai_gesture_recognition_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_gesture_recognition_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_gesture_recognition_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_GESTURE_RECOGNITION_*
 * defines into file @ref gesture_recognition.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_gesture_recognition_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_GESTURE_RECOGNITION_H */
